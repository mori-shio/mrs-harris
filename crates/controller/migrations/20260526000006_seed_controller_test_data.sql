...
(
    '1001',
    1,
    '{"タグ": ["local", "test"], "説明": "Controller本体で実行される軽量なテストジョブ", "ジョブ名": "local-echo-job", "ジョブタイプ": "OneShot (単発/手動実行)", "タイムアウト": "300 秒", "有効化状態": "有効", "初期遅延": "5 秒", "リトライ上限": "1", "バックオフ戦略": "固定", "ワーカー定義": "default-controller", "スクリプト": "echo Hello from Controller!", "Slack通知": {"成功時": "無効", "失敗時": "無効", "ジョブ起動時": "無効"}}',
    'system-admin',
